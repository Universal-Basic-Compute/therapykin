  ...
  return (
    <section className="py-20 px-4 relative">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <h2 className="text-3xl font-bold mb-4 text-center text-white">Built For Real Support</h2>
        <p className="text-center max-w-2xl mx-auto mb-16 text-white/90">
          Thoughtfully designed tools that make a meaningful difference in your mental health journey
        </p>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="card card-primary card-hover-lift p-6 transition-all bg-white/90 backdrop-blur-sm">
          ...
          <div className="card card-highlight card-hover-glow p-6 transition-all bg-white/90 backdrop-blur-sm">
            <div className="w-12 h-12 rounded-full bg-[var(--primary)]/10 flex items-center justify-center mb-4 text-[var(--primary)]">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="card card-accent card-hover-rotate p-6 transition-all bg-white/90 backdrop-blur-sm">
            <div className="w-12 h-12 rounded-full bg-[var(--primary)]/10 flex items-center justify-center mb-4 text-[var(--primary)]">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="card card-primary card-hover-border p-6 transition-all bg-white/90 backdrop-blur-sm">
            <div className="w-12 h-12 rounded-full bg-[var(--primary)]/10 flex items-center justify-center mb-4 text-[var(--primary)]">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="card card-highlight card-hover-scale p-6 transition-all bg-white/90 backdrop-blur-sm">
            <div className="w-12 h-12 rounded-full bg-[var(--primary)]/10 flex items-center justify-center mb-4 text-[var(--primary)]">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="card card-accent card-hover-lift p-6 transition-all bg-white/90 backdrop-blur-sm">
            <div className="w-12 h-12 rounded-full bg-[var(--primary)]/10 flex items-center justify-center mb-4 text-[var(--primary)]">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
